...
export function MultiLinkForm({ data, update }: QRFormProps) {
  ...
  return (
    <div className="grid gap-4">
      <TextInput label="Titel" value={data.multiLinksTitle} onChange={(value) => update("multiLinksTitle", value)} />
      <SwitchField
        label="Als einfache HTML-Daten-URL codieren"
        checked={data.multiLinksUseHtml}
        onChange={(value) => update("multiLinksUseHtml", value)}
        hint="Ohne Backend entsteht keine gehostete Landingpage."
      />
